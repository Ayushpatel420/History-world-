#!/usr/bin/env python3
"""
Populate Part 1: Asian Monuments (60) and European Monuments (60)
"""
import json
import os

def b(id, name, native, cat, loc, country, region, era, yr_str, yr_num, arch, style, dim, mat, hist, marv, mod, img, tags, facts, unesco="World Heritage Landmark"):
    return {
        "id": id,
        "name": name,
...
# Asian Monuments (60)
ASIAN_MONUMENTS = [
  b("taj-mahal", "Taj Mahal", "क्राउन ऑफ़ द पैलेस (Crown of the Palace)", "Famous Building", "Agra, Uttar Pradesh", "India", "Asia",
    "Mughal Empire Golden Age (1632–1653 CE)", "1632–1653 CE", 1648, "Ustad Ahmad Lahori, commissioned by Emperor Shah Jahan",
    "Mughal Architecture (Persian, Islamic, and Indian fusion)", "Height: 73 m (240 ft); Central dome diameter: 17.7 m; Complex area: 42 acres",
  ...
  b("great-wall-of-china", "Great Wall of China", "万里长城 (Wànlǐ Chángchéng - 10,000-Li Long Wall)", "Ancient Wonder", "Northern Frontier across 15 provinces", "China", "Asia",
  ...
  b("angkor-wat", "Angkor Wat", "អង្គរវត្ត (City Temple)", "Sacred Temple / Cathedral", "Siem Reap Province", "Cambodia", "Asia",
  ...
  b("burj-khalifa", "Burj Khalifa", "برج خليفة (Khalifa Tower)", "Monument & Tower", "Downtown Dubai", "United Arab Emirates", "Middle East",
  ...
  b("petra-treasury", "Al-Khazneh (The Treasury) & Petra", "الخزنة (The Treasury) / الرقيم (Raqmu)", "Ancient Wonder", "Ma'an Governorate", "Jordan", "Middle East",
  ...
  b("forbidden-city", "The Forbidden City", "故宫 (Gùgōng) / 紫禁城 (Purple Forbidden City)", "Palace & Fortress", "Beijing", "China", "Asia",
  ...
  b("himeji-castle", "Himeji Castle (White Heron Castle)", "姫路城 (Himeji-jō - Shirasagijō)", "Palace & Fortress", "Himeji, Hyōgo Prefecture", "Japan", "Asia",
  ...
  b("borobudur-temple", "Borobudur Temple Compounds", "Candi Borobudur", "Sacred Temple / Cathedral", "Central Java", "Indonesia", "Asia",
  ...
  b("fushimi-inari-taisha", "Fushimi Inari-Taisha Shrine", "伏見稲荷大社 (Grand Shinto Shrine of Inari)", "Sacred Temple / Cathedral", "Fushimi-ku, Kyoto", "Japan", "Asia",
  ...
  b("kinkaku-ji", "Kinkaku-ji (The Golden Pavilion)", "金閣寺 (Rokuon-ji)", "Sacred Temple / Cathedral", "Kita-ku, Kyoto", "Japan", "Asia",
...
print(f"Base items loaded: {len(ASIAN_MONUMENTS)}")
