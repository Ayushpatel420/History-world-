# Data for 60 Asian Monuments
ASIAN_MONUMENTS_DATA = [
  # 1. Taj Mahal
  {
    "id": "taj-mahal",
    "name": "Taj Mahal",
  ...
  # 6. Forbidden City
  {
    ...
    "nativeOrAlternateName": "故宫 (Gùgōng) / 紫禁城 (Purple Forbidden City)",
    "category": "Palace & Fortress",
    "location": "Beijing",
    "country": "China",
    "region": "Asia",
    "era": "Ming & Qing Dynasties (1406–1912 CE)",
    "yearBuilt": "1406–1420 CE",
    "numericYear": 1420,
    "architectOrCreator": "Yongle Emperor (Zhu Di); Master Architect Kuai Xiang",
    "architecturalStyle": "Traditional Imperial Chinese Palace Architecture (Feng Shui, Dougang)",
    "dimensionsAndHeight": "Complex area: 72 hectares (178 acres); 980 surviving buildings; 8,886 room bays; Wall height: 10 m",
    "materialsUsed": "Phoebe zhennan logs, 'golden bricks', yellow glazed ceramic tiles, white marble terraces",
    "historyAndBackground": "The Forbidden City was the imperial palace of China from 1420 to 1912, housing 24 successive emperors of the Ming and Qing dynasties. Built over 14 years by one million workers on the orders of the Yongle Emperor, who moved the capital from Nanjing to Beijing. Commoners were strictly forbidden from entering under penalty of execution. It was the stage for five centuries of dynastic politics, the fall of the Ming, the Manchu conquest, and the abdication of Puyi in 1912.",
    "architecturalMarvels": "Arranged along a precise north-south meridian axis aligning with the North Star. Constructed entirely without iron nails using interlocking timber dougong brackets that flex to withstand major earthquakes. Roofs are covered in imperial yellow tiles, reserved exclusively for the sovereign. The Hall of Supreme Harmony features a marble terrace with 1,142 dragon heads that spout rainwater during summer storms.",
    "modernStatusAndSignificance": "Inscribed as a UNESCO World Heritage Site in 1987 as the world's largest collection of preserved wooden structures. Today it houses the Palace Museum, displaying over 1.8 million imperial artifacts.",
    "imageUrl": "https://images.unsplash.com/photo-1584646098378-0874589d76b1?auto=format&fit=crop&q=80&w=1200",
    "fallbackImageUrl": "https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?auto=format&fit=crop&q=80&w=1200",
    "tags": ["Forbidden City", "Beijing", "China", "Imperial Palace", "Ming", "Qing", "UNESCO"],
    "keyFacts": [
      "Home of 24 Chinese emperors across the Ming and Qing dynasties for 492 years",
      "Built with interlocking wooden mortise-and-tenon joints without a single iron nail",
      "Floor 'golden bricks' were fired for months in clay kilns to ring like chimes when stepped on",
      "Contains 980 preserved wooden buildings and exactly 8,886 rooms"
    ],
    "unescoStatus": "Inscribed 1987 (Criteria i, ii, iii, iv)"
  },
  # 7. Himeji Castle
  {
    "id": "himeji-castle",
    "name": "Himeji Castle (White Heron Castle)",
    "nativeOrAlternateName": "姫路城 (Himeji-jō - Shirasagijō)",
    "category": "Palace & Fortress",
    "location": "Himeji, Hyōgo Prefecture",
    "country": "Japan",
    "region": "Asia",
    "era": "Sengoku to Edo Period (1333–1609 CE)",
    "yearBuilt": "1601–1609 CE",
    "numericYear": 1609,
    "architectOrCreator": "Ikeda Terumasa, son-in-law of Shogun Tokugawa Ieyasu",
    "architecturalStyle": "Japanese Feudal Hilltop (Hirayama) Castle Architecture",
    "dimensionsAndHeight": "Main keep height: 46.4 m (152 ft); Altitude: 92 m; Grounds: 107 hectares",
    "materialsUsed": "Giant cypress timber pillars, cyclopean granite stone walls, fireproof white plaster",
    ...
    "architecturalMarvels": "Features a lethal defensive labyrinth of gates and dead-ends designed to trap attackers in firing zones under 997 shooting embrasures (sama). Foundation walls curve outward to prevent climbing. Supported by two massive 25-meter cypress columns extending from the ground to the top floor.",
    "modernStatusAndSignificance": "Japan's first UNESCO World Heritage Site (1993) and a designated National Treasure of Japan.",
    "imageUrl": "https://images.unsplash.com/photo-1578637387939-43c525550085?auto=format&fit=crop&q=80&w=1200",
    "fallbackImageUrl": "https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&q=80&w=1200",
    "tags": ["Himeji Castle", "Japan", "Samurai", "White Heron", "UNESCO", "Castle"],
    "keyFacts": [
      "Japan's most pristine feudal castle, surviving WWII bombing and the 1995 Kobe earthquake",
      "Outer plaster is infused with crushed seashell to provide fire resistance",
      "Incorporates 997 shooting embrasures engineered for matchlock guns and arrows",
      "Concentric spiral paths lead attackers away from the central keep into kill zones"
    ],
  ...
  # 8. Borobudur
  {
    ...
    "nativeOrAlternateName": "Candi Borobudur",
    "category": "Sacred Temple / Cathedral",
    ...
    "numericYear": 825,
    "architectOrCreator": "Master Architect Gunadharma under Sailendra Kings",
    "architecturalStyle": "Javanese Buddhist Stupa Mandala",
    "dimensionsAndHeight": "Base: 123 × 123 m (403 ft); Height: 35 m (115 ft); Volume: 55,000 m³ stone",
    "materialsUsed": "Over 2 million volcanic andesite stone blocks carved without mortar",
    "historyAndBackground": "Borobudur is the largest Buddhist monument in the world. Constructed around 800 CE in Java during the Sailendra Dynasty. Following volcanic eruptions from Mount Merapi and political shifts, it was abandoned in the 14th century and swallowed by jungle and volcanic ash. Rediscovered in 1814 by British governor Thomas Stamford Raffles and excavated over decades.",
    "architecturalMarvels": "Built as a giant three-dimensional stone mandala representing Buddhist cosmology: Kamadhatu (desire), Rupadhatu (forms), and Arupadhatu (formlessness). Contains 2,672 carved relief panels and 72 perforated bell-shaped stupas, each housing a seated Buddha statue on the circular upper terraces.",
    "modernStatusAndSignificance": "UNESCO World Heritage Site (1991). The sacred epicenter for global celebrations of Vesak Day in Southeast Asia.",
    "imageUrl": "https://images.unsplash.com/photo-1596402184320-417e7178b2cd?auto=format&fit=crop&q=80&w=1200",
    "fallbackImageUrl": "https://images.unsplash.com/photo-1588668214407-6ea9a6d8c272?auto=format&fit=crop&q=80&w=1200",
    "tags": ["Borobudur", "Indonesia", "Buddhist", "Java", "UNESCO", "Mandala"],
    "keyFacts": [
      "World's largest Buddhist temple monument, built from 2 million volcanic stones",
      "Constructed entirely without mortar using interlocking tongue-and-groove joints",
      "Features 2,672 narrative stone relief panels and 504 Buddha statues",
      "Lay buried under volcanic ash for centuries until its rediscovery in 1814"
    ],
  ...
  # 9. Fushimi Inari
  {
    ...
    "nativeOrAlternateName": "伏見稲荷大社 (Grand Shinto Shrine of Inari)",
    "category": "Sacred Temple / Cathedral",
    "location": "Fushimi-ku, Kyoto",
    "country": "Japan",
    "region": "Asia",
    "era": "Nara to Edo Period (711 CE – Present)",
    "yearBuilt": "Founded 711 CE; Main Hall rebuilt 1499 CE",
    "numericYear": 711,
    "architectOrCreator": "Hata clan chieftain Hata no Irogu",
    "architecturalStyle": "Traditional Japanese Shinto Shrine Architecture (Nagare-zukuri)",
    "dimensionsAndHeight": "Mount Inari trail: 4 km (2.5 miles); Over 10,000 vermilion torii gates",
    "materialsUsed": "Japanese cypress timber (hinoki), vermilion and black cinnabar lacquer, carved stone fox statues (kitsune)",
    ...
    "architecturalMarvels": "The iconic Senbon Torii features thousands of vivid vermilion torii gates creating tunnels through sacred Mount Inari. The vermilion color, derived from cinnabar, repels evil forces and wood decay in Shinto belief. Each gate is inscribed with the donor company or family and date of dedication. Stone foxes hold symbolic granary keys or sacred jewels in their mouths.",
    "modernStatusAndSignificance": "Regularly voted the top cultural destination in Japan by global travelers. Part of Ancient Kyoto's heritage fabric.",
    "imageUrl": "https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?auto=format&fit=crop&q=80&w=1200",
    "fallbackImageUrl": "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&q=80&w=1200",
    "tags": ["Fushimi Inari", "Kyoto", "Japan", "Shinto", "Torii Gates", "Shrine"],
    "keyFacts": [
      "Features over 10,000 vermilion torii gates winding up sacred Mount Inari",
      "Dedicated to Inari, kami of agriculture, rice harvest, and business fortune",
      "Fox statues (kitsune) serve as messengers holding keys to harvest granaries",
      "Every single torii gate is funded and donated by Japanese businesses or families"
    ],
    "unescoStatus": "Important Cultural Property of Japan"
  },
  # 10. Kinkaku-ji
  {
    "id": "kinkaku-ji",
    "name": "Kinkaku-ji (The Golden Pavilion)",
    "nativeOrAlternateName": "金閣寺 (Rokuon-ji)",
    "category": "Sacred Temple / Cathedral",
    "location": "Kita-ku, Kyoto",
    "country": "Japan",
    "region": "Asia",
    "era": "Muromachi Period (1397 CE)",
    "yearBuilt": "1397 CE (Rebuilt 1955)",
    "numericYear": 1397,
    "architectOrCreator": "Shogun Ashikaga Yoshimitsu",
    "architecturalStyle": "Kitayama Culture Zen Buddhist & Shinden-zukuri Fusion",
    "dimensionsAndHeight": "Height: 12.5 m (41 ft); 3-story pavilion; Mirror Pond: 6,600 m²",
    "materialsUsed": "Japanese cypress frame, pure gold leaf gilding, Japanese urushi lacquer, bronze phoenix",
    "historyAndBackground": "Built in 1397 as a retirement villa for third Ashikaga Shogun Yoshimitsu, who converted it to a Rinzai Zen temple upon his death. The pavilion miraculously survived the Onin War when most of Kyoto was burned. In 1950, a novice monk burned the 550-year-old pavilion to the ground, an event immortalized in Yukio Mishima's novel. Meticulously reconstructed in 1955 using 20 kg of gold leaf.",
    "architecturalMarvels": "Synthesizes three architectural styles across three floors: Heian aristocratic palace style on the ground, samurai warrior hall style on the middle, and Chinese Zen temple style on the top. The top two stories are gilded in pure gold leaf. Perched beside the Mirror Pond, casting a shimmering golden reflection amidst pine trees.",
    "modernStatusAndSignificance": "UNESCO World Heritage Site (1994, Historic Monuments of Ancient Kyoto). One of Japan's most celebrated aesthetic landmarks.",
    "imageUrl": "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&q=80&w=1200",
    "fallbackImageUrl": "https://images.unsplash.com/photo-1492571350019-22de08371fd3?auto=format&fit=crop&q=80&w=1200",
    "tags": ["Kinkaku-ji", "Golden Pavilion", "Kyoto", "Japan", "Zen", "Ashikaga", "UNESCO"],
    "keyFacts": [
      "Top two floors are completely gilded in pure gold leaf over natural lacquer",
      "Combines three distinct historical architectural styles on each of its three stories",
      "The roof is crowned with a solid bronze Chinese phoenix (Fenghuang)",
      "Designed specifically to project a pristine unbroken reflection across Mirror Pond"
    ],
    "unescoStatus": "Inscribed 1994 (Historic Monuments of Ancient Kyoto)"
  }
]

print(f"Loaded initial {len(ASIAN_MONUMENTS_DATA)} Asian monuments.")
