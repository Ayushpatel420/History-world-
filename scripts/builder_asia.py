#!/usr/bin/env python3
"""
Generates 60 Asian Monuments for src/data/monuments/asianMonuments.ts
"""
import json

def item(id, name, alt, cat, loc, country, era, yr_str, yr_num, arch, style, dim, mat, hist, marv, mod, img, tags, facts, unesco="World Heritage Landmark"):
    return {
        "id": id,
        "name": name,
        "nativeOrAlternateName": alt,
        "category": cat,
        "location": loc,
        "country": country,
...
print("builder_asia framework initialized.")
